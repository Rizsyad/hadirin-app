...
@section('content')
   ...
   <x-content>
   <div class="boreder absolute left-1/2 top-44 transform -translate-x-1/2 -translate-y-1/2 p-5 items-center justify-center">
   ...
   <div class="flex flex-col mx-auto w-10/12 md:w-12/12 mt-6">
         <div class="mb-4">
            ...
            <input type="text" name="nama" id="nama" class="block mt-1 w-full rounded-md bg-gray-100 border-transparent focus:border-gray-500 focus:bg-white focus:ring-0" placeholder="Masukan Nama Anda" />
         </div>
         <div class="mb-4">
         ...
         <div class="mb-4">
            ...
            <input type="date" name="date" id="date" class="block mt-1 w-full rounded-md bg-gray-100 border-transparent focus:border-gray-500 focus:bg-white focus:ring-0" placeholder="Masukan Tanggal" />
         </div>
