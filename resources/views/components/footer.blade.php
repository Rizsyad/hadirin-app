<footer class="fixed bottom-0 left-0 z-50 w-full h-16 bg-white border-t">
    <div class="grid h-full grid-cols-3 mx-auto font-medium mt-1">
        <x-nav href="/views/home" class="inline-flex flex-col items-center justify-center px-5 hover:text-[#44B156]">
            <i class="fa fa-house mb-1 w-5 h-5"></i>
            <span class="text-sm">Home</span>
        </x-nav>
        <x-nav href="/views/presensi" class="inline-flex flex-col items-center justify-center px-5 hover:text-[#44B156]">
            <i class="fa-solid fa-calendar mb-1 w-5 h-5"></i>
            <span class="text-sm">Presensi</span>
        </x-nav>
        <x-nav href="/views/profile" class="inline-flex flex-col items-center justify-center px-5 hover:text-[#44B156]">
